...
<html>
    ...
    <body>
        ...
        <%
            String nome_musica = request.getParameter("nome_musica");
            String nome_artista = request.getParameter("nome_artista");
            ...
            try {
                ...
                String sql = "INSERT INTO musicas (nome_musica, nome_artista, duracao) VALUES (?, ?, ?)";
                ...
                // Mensagem de sucesso
                out.print("<p style='color:green;font-size:30px;'> Música cadastrada com sucesso! </p>");
            } catch (Exception e) {
                ...
                try {
                    ...
                    out.print("<p style='color:red;font-size:30px;'>Erro ao fechar recursos: " + e.getMessage() + "</p>");
                }
            }
        %>
